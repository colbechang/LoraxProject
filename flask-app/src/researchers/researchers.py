...
@researchers.route('/mitigation_techniques', methods=['GET'])
...
@researchers.route('/adaptation_techniques', methods=['GET'])
...
@researchers.route('/climate_change_trends', methods=['POST'])
def insert_cct():
...
@researchers.route('/radiative_forcing', methods=['POST'])
def insert_cct():
...
@researchers.route('/adaptation_techniques', methods=['POST'])
def insert_cct():
...
@researchers.route('/mitigation_techniques', methods=['POST'])
def insert_cct():
